...
public class Calculadora {
    public static void main(String[] args) {
        ...
        // Criar uma Loja e adicionar exemplos de clientes e vendedores
        Loja loja = new Loja("Loja Carros", "Carros", "12.345.678/0001-90", "Quedas do Iguaçu", "Centro", "Marfim");
        loja.adicionarCliente(new Cliente("Ana", 28, "Quedas do Iguaçu", "centro", "Rua A"));
        loja.adicionarCliente(new Cliente("Bruno", 35, "Quedas do Iguaçu", "Pindorama", "Rua B"));
        loja.adicionarVendedor(new Vendedor("Carla", 30));
        loja.adicionarVendedor(new Vendedor("Diego", 40));
        ...
        while (alternativa != 6) {
            System.out.println("    [1] - Calcular Preço Total\r\n" +
                    ...
                    "    [6] - Contar Clientes da Loja\r\n" +
                    "    [7] - Contar Vendedores da Loja\r\n" +
                    "    [8] - Sair\r\n" );
            ...
            switch (alternativa) {
                ...
                case 6:
                    // Mostrar quantidade de clientes na loja
                    loja.contarClientes();
                    break;

                case 7:
                    // Mostrar quantidade de vendedores na loja
